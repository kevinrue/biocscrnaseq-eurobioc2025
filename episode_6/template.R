...
#############################################
# Spot some differences between the tissue and tissue_harmonised columns. Use 
# count to summarise.
...
###########################################
# Now that we are a little familiar with navigating the metadata, let’s obtain a
# SingleCellExperiment of 10X scRNA-seq counts of cd8 tem lung cells for females
# older than 80 with COVID-19. Note: Use the harmonized columns, where possible.
